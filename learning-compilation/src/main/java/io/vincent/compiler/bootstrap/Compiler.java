...
import io.vincent.compiler.ast.AST;
import io.vincent.compiler.ast.ExpressionNode;
import io.vincent.compiler.ast.StatementNode;
import io.vincent.compiler.config.CompilerMode;
import io.vincent.compiler.config.Options;
import io.vincent.compiler.config.SourceFile;
import io.vincent.compiler.core.IRGenerator;
import io.vincent.compiler.exception.*;
import io.vincent.compiler.ir.IR;
import io.vincent.compiler.parser.Parser;
import io.vincent.compiler.sysdep.AssemblyCode;
...
public class Compiler {
	 ...
	 */
	private void build(List<SourceFile> srcs, Options options) throws CompileException {
