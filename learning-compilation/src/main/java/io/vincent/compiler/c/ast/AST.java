...
public class AST implements Node {
    ...
    public StatementNode getSingleMainStmt() {
    ...
    public ExpressionNode getSingleMainExpr() {
        StatementNode stmt = getSingleMainStmt();
        if (stmt == null) {
            return null;
        }
        else if (stmt instanceof ExpressionStatementNode) {
            return ((ExpressionStatementNode)stmt).expr();
        }
